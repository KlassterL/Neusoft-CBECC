            ...
            <div
                ...
                <div class="w-full surface-card py-8 px-5 sm:px-8 flex flex-column align-items-center"
                    ...
                    <div class="grid flex flex-column align-items-center">
                        <img src="layout/images/logo.svg" class="mb-4" />
                        ...
                        <span class="text-600 mb-5">你没有访问该页面的权限，请联系管理员...</span>
                        <div class="col-12 mt-5 text-center">
                            <i class="pi pi-fw pi-arrow-left text-blue-500 mr-2" style="vertical-align: center"></i>
                            <router-link to="/" class="text-blue-500">返回主页</router-link>
                        </div>
                        <div class="col-12 -mt-2 text-center">
                            <i class="pi pi-fw pi-arrow-left text-blue-500 mr-2" style="vertical-align: center"></i>
                            <router-link to="/login" class="text-blue-500">前往登录</router-link>
                        </div>
                    </div>
                </div>
            </div>
